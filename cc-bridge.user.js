...
(function () {
    ...
    ensureGisLoaded(function () {
      if (!driveTokenClient) {
        driveTokenClient = pageWindow.google.accounts.oauth2.initTokenClient({
          ...
          // success/cancel path above was reachable. the site's own
          // equivalent (its own Drive auth code) wires this
  ...
  function uploadCardToGoogleDrive(cardData) {
    ...
    canvas.toBlob(function (blob) {
      ...
      // call in the site's uploadFile (its own Drive upload code, commit
      // ).
